...
class FeedbackActivity :BaseActivity(){
    ...
    override fun init() {
        //设置编码
        wvFeedback.getSettings().setDefaultTextEncodingName("utf-8")
        //支持js
        wvFeedback.getSettings().setJavaScriptEnabled(true)
        //设置背景颜色 透明
        //Color.argb(0, 0, 0, 0)
        wvFeedback.setBackgroundColor(
        ...
        //添加webview客户端
        wvFeedback.setWebViewClient(MyWebViewClient())
        //添加浏览器客户端
        wvFeedback.setWebChromeClient(MyWebChromeClient())
        //注销说明地址
        wvFeedback.loadUrl("https://wj.qq.com/s2/7680210/aca4/")
    }
