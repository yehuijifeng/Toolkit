...
import com.wwxd.qr_code1.decode.DecodeImgCallback
import com.wwxd.qr_code1.decode.DecodeImgThread
import com.wwxd.qr_code1.encode.CodeCreator
...
class QR_codeFragment : BaseFragment() {
    ...
    override fun init(view: View) {
        btnCamera.setOnClickListener {//拍照
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (requestCode == PhoneUtil.CODE_FOR_PHOTO
