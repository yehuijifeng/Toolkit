...
public class ImageClipView extends View {
    ...
    private Runnable runnable = this::redrawImageClipView;
    ...
    private void calculateClipperBorder(InputCondition condition) {
        ...
        int padding1 = DisplayUtil.INSTANCE.getWindowWidth() / 4;
        clipBorderCondition.layoutLeft = padding1;
        clipBorderCondition.layoutTop = padding1;
        clipBorderCondition.layoutRight = DisplayUtil.INSTANCE.getWindowWidth() - padding1;
        clipBorderCondition.layoutBottom = DisplayUtil.INSTANCE.getWindowWidth() - padding1;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (clipBorderCondition == null) return;
        if (clipBorderCondition.type == ClipBorderType.Rectangle) {
